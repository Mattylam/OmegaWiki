...
## [2026-04-17] ingest | claims for system-prompt-optimization-meta-learning: 0 matched existing, 1 new
## [2026-04-17] ingest | concepts for system-prompt-optimization-meta-learning: 1 matched existing (reflective-prompt-evolution), 1 new (meta-prompt-optimization), 1 foundation-refs (prompt-optimization), 0 new foundations, 0 terminology-refs, 0 new terminology
## [2026-04-17] ingest | added papers/system-prompt-optimization-meta-learning | new: concepts/meta-prompt-optimization, claims/meta-learned-system-prompts-transfer-unseen, people/sung-ju-hwang | updated: concepts/reflective-prompt-evolution, papers/gepa-reflective-prompt-evolution-outperform-reinforcement
## [2026-04-17] ingest | claims for task-facet-learning-structured-approach-prompt: 0 matched existing, 1 new
## [2026-04-17] ingest | concepts for task-facet-learning-structured-approach-prompt: 2 matched existing (reflective-prompt-evolution, meta-prompt-optimization), 1 new (sectioned-prompt-optimization), 1 foundation-refs (prompt-optimization), 0 new foundations, 0 terminology-refs, 0 new terminology
## [2026-04-17] ingest | added papers/task-facet-learning-structured-approach-prompt | new: concepts/sectioned-prompt-optimization, claims/sectioned-prompts-batch-aggregated-facet-feedback, people/amit-sharma | updated: concepts/reflective-prompt-evolution, concepts/meta-prompt-optimization, papers/system-prompt-optimization-meta-learning, papers/gepa-reflective-prompt-evolution-outperform-reinforcement
## [2026-04-17] terminology | added auxiliary-llm (aliases: expert LLM, optimizer LLM) — generic vocabulary for a secondary LLM supporting prompt optimization of a primary solver LLM
## [2026-04-21] ingest | claims for intent-based-prompt-calibration-enhancing-prompt: 0 matched existing, 1 new
## [2026-04-21] ingest | concepts for intent-based-prompt-calibration-enhancing-prompt: 0 matched existing, 1 new concepts, 1 foundation-refs, 0 new foundations, 0 terminology-refs, 0 new terminology
## [2026-04-21] ingest | claims for generate-evaluate-iterate-synthetic-data-human: 0 matched existing, 1 new
## [2026-04-21] ingest | concepts for generate-evaluate-iterate-synthetic-data-human: 1 matched existing (synthetic-boundary-case-optimization, Branch A), 0 new concepts, 1 foundation-refs, 0 new foundations, 0 terminology-refs, 0 new terminology
## [2026-04-21] ingest | added papers/what-lost-synthetic-evaluation | updated: concepts/synthetic-evaluation-quality-gap, claims/llm-generated-evaluation-benchmarks-sacrifice-difficulty
## [2026-04-21] ingest | claims for what-lost-synthetic-evaluation: 0 matched existing, 1 new
## [2026-04-21] ingest | concepts for what-lost-synthetic-evaluation: 0 matched existing, 1 new concepts, 0 foundation-refs, 0 new foundations, 0 terminology-refs, 0 new terminology
## [2026-04-21] ingest | claims for prorefine-inference-time-prompt-refinement-textual: 0 matched existing, 1 new
## [2026-04-21] ingest | concepts for prorefine-inference-time-prompt-refinement-textual: 1 matched existing (reflective-prompt-evolution, Branch A), 0 new concepts, 1 foundation-refs, 0 new foundations
## [2026-04-21] ingest | claims for automatic-prompt-optimization-techniques-exploring-potential: 0 matched existing, 0 new (survey, importance 2, no empirical claims)
## [2026-04-21] ingest | concepts for automatic-prompt-optimization-techniques-exploring-potential: 0 matched existing, 0 new concepts, 2 foundation-refs, 0 new foundations
## [2026-04-21] ingest | added papers/intent-based-prompt-calibration-enhancing-prompt | updated: concepts/synthetic-boundary-case-optimization (new), claims/synthetic-boundary-case-generation-during-prompt (new)
## [2026-04-21] ingest | added papers/generate-evaluate-iterate-synthetic-data-human | updated: concepts/synthetic-boundary-case-optimization (variant added), claims/synthetic-borderline-case-generation-effective-hand (new)
## [2026-04-21] ingest | added papers/what-lost-synthetic-evaluation | updated: concepts/synthetic-evaluation-quality-gap (new), claims/llm-generated-evaluation-benchmarks-sacrifice-difficulty (new)
## [2026-04-21] ingest | added papers/prorefine-inference-time-prompt-refinement-textual | updated: concepts/reflective-prompt-evolution (ProRefine variant added), claims/inference-time-agentic-prompt-refinement-textual (new)
## [2026-04-21] ingest | added papers/automatic-prompt-optimization-techniques-exploring-potential | updated: concepts/reflective-prompt-evolution, concepts/synthetic-boundary-case-optimization (survey support)
## [2026-04-24] ingest | claims for reasoningbank-scaling-agent-self-evolving-reasoning: 1 matched existing (continual-learning-via-external-memory), 1 new (distilling-reasoning-strategies-failed-successful-agent)
## [2026-04-24] ingest | concepts for reasoningbank-scaling-agent-self-evolving-reasoning: 1 matched existing (skill-memory via Branch A variant), 1 new concepts (agent-reasoning-memory), 0 foundation-refs, 0 new foundations, 2 foundation-refs (react-prompting, retrieval-augmented-generation), 0 new terminology
## [2026-04-24] ingest | added papers/reasoningbank-scaling-agent-self-evolving-reasoning | updated: concepts/skill-memory, claims/continual-learning-via-external-memory | created: concepts/agent-reasoning-memory, claims/distilling-reasoning-strategies-failed-successful-agent, people/jiawei-han
## [2026-04-26] ingest | claims for don-retrieve-navigate-distilling-enterprise-knowledge: 0 matched existing, 1 new (llm-agent-navigating-hierarchical-pre-compiled)
## [2026-04-26] ingest | concepts for don-retrieve-navigate-distilling-enterprise-knowledge: 1 matched existing (skill-memory via variant), 1 new concepts (hierarchical-corpus-navigation), 1 foundation-refs (retrieval-augmented-generation), 0 new foundations, 0 terminology
## [2026-04-26] ingest | added papers/don-retrieve-navigate-distilling-enterprise-knowledge | updated: concepts/skill-memory | created: concepts/hierarchical-corpus-navigation, claims/llm-agent-navigating-hierarchical-pre-compiled
## [2026-04-27] ingest | claims for sok-agentic-skills-beyond-tool-use: 0 matched existing, 1 new
## [2026-04-27] ingest | concepts for sok-agentic-skills-beyond-tool-use: 1 matched existing (skill-memory), 1 new concepts (agentic-skill-design-patterns), 0 foundation-refs, 0 new foundations, 0 terminology-refs, 0 new terminology
## [2026-04-27] ingest | added papers/sok-agentic-skills-beyond-tool-use | updated: concepts/skill-memory, concepts/agentic-skill-design-patterns (new), claims/curated-skills-outperform-self-generated-skills (new)
## [2026-04-27] edit | added foundations/shot-dark-problem | structural limitation of agentic RAG without corpus map visibility
## [2026-04-27] edit | moved foundations/shot-dark-problem → concepts/shot-dark-problem | converted to active concept with full concept template
## [2026-05-01] ingest | claims for taming-actor-observer-asymmetry-agents-dialectical: 0 matched existing, 1 new
## [2026-05-01] ingest | concepts for taming-actor-observer-asymmetry-agents-dialectical: 0 matched existing, 1 new concepts, 2 foundation-refs, 0 new foundations, 0 terminology-refs, 0 new terminology
## [2026-05-01] ingest | added papers/taming-actor-observer-asymmetry-agents-dialectical | updated: concepts/actor-observer-asymmetry (new), claims/actor-observer-asymmetry-llm-agents (new), graph/edges.jsonl (+4 edges)
## [2026-05-04] ingest | claims for measuring-agents-production: 0 matched existing, 1 new
## [2026-05-04] ingest | concepts for measuring-agents-production: 0 matched existing, 1 new concepts, 1 foundation-refs (human-in-the-loop-learning), 0 new foundations, 0 terminology-refs, 0 new terminology
## [2026-05-04] ingest | added papers/measuring-agents-production | updated: concepts/production-agent-deployment-patterns (new), claims/production-agents-rely-simple-prompt-based (new), people/matei-zaharia, people/lakshya-agrawal, graph/edges.jsonl (+3 edges)
